...
const m1 = {
  ...
  main: [
    ...
    P("요즘 흔한 ‘압축 롤팩’ 매트리스는 개봉 타이밍도 챙기세요. 보통 " + B("받고 30일 안에 펴야 하고, 완전히 부풀어 제 형태가 되기까진 24~72시간") + "이 걸려요(장기 압축 보관은 영구 꺼짐·보증 무효 위험). 새 폼 특유의 냄새(VOC)는 대개 첫 며칠이면 빠지니, 깐 뒤 환기하며 며칠 두고 평가하세요."),
    H2("사기 전 체크리스트"),
    NUMLIST(SMART, [
...
const m2 = {
  ...
  main: [
    ...
    P("그리고 ‘다 넣어도 되는 건 아니에요.’ " + B("코팅 프라이팬·나무 도마·칼·알루미늄·놋·크리스탈") + "은 고온·세제에 손상되거나 변색돼 손세척이 권장돼요. 세척도 즉시가 아니라 표준 1~2시간·자동 2~3시간이 걸리니, ‘급할 때 바로’를 기대하면 실망할 수 있고요."),
    H2("사기 전 체크리스트"),
    NUMLIST(PURPLE, [
...
const m3 = {
  ...
  main: [
    ...
    P("안전도 한 줄 짚을게요. 건강한 성인에겐 대체로 안전하지만, " + B("면역저하자·중증 환자·미숙아·영유아는 섭취 전 전문가와 상의") + "가 필요해요(드물게 균혈증 보고, 미국 FDA의 미숙아 경고도 있어요). 그리고 ‘유산균 든 발효유(일반식품)’와 ‘기능성 인정 건강기능식품’은 균수 기준도 표시도 다른 물건이라는 점, 다시 한 번요."),
    H2("사기 전 체크리스트"),
    NUMLIST(TEAL, [
      "건강기능식품 인증마크가 있는가",
