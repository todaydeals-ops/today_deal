...
export const BEAUTY_CATEGORIES: BeautyCategory[] = [
  {
    ...
    slugs: ["ceramide-barrier","hyaluronic-acid-topical","skin-barrier-basics","panthenol-madecassoside","moisturizer-occlusive-humectant"],
  },
  {
  ...
  },
  {
    ...
    slugs: ["bha-salicylic-pore","benzoyl-peroxide-acne","aha-pha-exfoliant"],
  },
  {
