...
export const SLEEP_CATEGORIES: SleepCategory[] = [
  ...
  {
    key: "study", label: "공부잘하는 잠", angle: "집중·기억 공고화",
  ...
  {
    key: "work", label: "일잘하는 잠", angle: "피로회복·생산성",
